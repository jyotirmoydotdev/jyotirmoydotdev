...
function Page() {
  return (
    <div className="flex justify-center bg-gray-100 dark:bg-gray-900 py-10">
      <div id="resume" className="w-[210mm] h-[297mm] overflow-hidden bg-white shadow-lg p-[10mm] text-sm space-y-4">
        <div className=" grid grid-cols-3 gap-4 ">
          ...
          {/* Contact Info */}
          <div className="flex flex-col justify-center gap-1 text-xs pb-3">

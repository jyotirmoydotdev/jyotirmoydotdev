    ...
    >
      <TooltipProvider>
        <div className="flex flex-col gap-4">
          ...
          <div className="hidden sm:block text-xs line-clamp-3 sm:text-sm dark:text-white/80 text-black/80 group-hover/project:text-orange-900 dark:group-hover/project:text-orange-100 transition-colors">
            {blog.description}
          </div>
        </div>
        <div className="hidden sm:flex gap-2 flex-wrap text-xs text-orange-500">
          Read More
        </div>
      </TooltipProvider>
    </Link>
